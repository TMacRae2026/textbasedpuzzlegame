...
public class TextBasedPuzzleGame {
    ...
    static void initRooms() {
        ...
        //different arraylists of items that will be in rooms
        ...
        ArrayList<Item> goodRoomItems = new ArrayList<>();
        goodRoomItems.add(new Sword("Strong_Steel"));
        ...
        randRoomList.add(new Room("""
                                  The room has an anvil and a sword laying on it. The anvil is far to heavy to pickup, but it might be nice to have a sword with you in the dangerous maze!""", 
                goodRoomItems, 
                false));
    ...
    public static void main(String[] args) {
        ...
        while(true) {
            ...
            //If we finish the game, print the end screen of the game and break the loop
